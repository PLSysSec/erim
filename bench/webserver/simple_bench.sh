...
sleep 1
ab -k -t 5 -c 100 -n 200000000   https://localhost/128kb >> /dev/null # Warmup run
echo "----0kb" > erimized.log
ab -k -t $1 -c 100 -n 200000000   https://localhost/0kb >> erimized.log
echo "----1kb" >> erimized.log
ab -k -t $1 -c 100 -n 200000000   https://localhost/1kb >> erimized.log
echo "----2kb" >> erimized.log
ab -k -t $1 -c 100 -n 200000000   https://localhost/2kb >> erimized.log
echo "----4kb" >> erimized.log
ab -k -t $1 -c 100 -n 200000000   https://localhost/4kb >> erimized.log
echo "----8kb" >> erimized.log
ab -k -t $1 -c 100 -n 200000000   https://localhost/8kb >> erimized.log
echo "----16kb" >> erimized.log
ab -k -t $1 -c 100 -n 200000000   https://localhost/16kb >> erimized.log
echo "----32kb" >> erimized.log
ab -k -t $1 -c 100 -n 200000000   https://localhost/32kb >> erimized.log
echo "----64kb" >> erimized.log
ab -k -t $1 -c 100 -n 200000000   https://localhost/64kb >> erimized.log
echo "----128kb" >> erimized.log
ab -k -t $1 -c 100 -n 200000000   https://localhost/128kb >> erimized.log
sudo pkill nginx
